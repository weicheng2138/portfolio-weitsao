    ...
    <div>
        ...
        <main>
            ...
            <section>
                ...
                <p class="text-center mt-6 mb-10">
                    Before | 字級不同、排列不一、背景底色，讓資訊判讀變得不容易
                </p>

                <img src="~/assets/gif/metro-status.gif" alt="metro-status" />
                <p class="text-center mt-6 mb-10">
                    Before | 字級不同、排列不一、背景底色，讓資訊判讀變得不容易
                </p>

                <h3 class="mb-4">?!｜問題與解決</h3>
                <p class="mb-20">
                    在設計這個區塊時，遇到最猶豫的問題，就是要不要捨棄路線中文？<br /><br />因為當畫面使用在最窄的裝置時，會因為寬度不足，而無法顯示中文。但是如果只標示出英文代號，大家都會知道是哪一條路線嗎？在多種嘗試之後，因為要將各線全部一次展示在首頁，而且判斷旅客仍然可以依照顏色辨別路線，最後決定在斷點414以下的畫面，仍像原版指顯示英文代碼，而不顯示中文。<br /><br />註：後來發現東京
                    Metro
            ...
            <section>
                <h1 class="text-center mb-20">
                    設計畫面 02 - <br class="md:hidden" />被淹沒的「最新消息」
                </h1>
                <h3 class="mb-4">01｜讓「最新消息」能容易被看見</h3>
                <p class="mb-20">
                ...
                <div class="flex flex-row justify-around mb-6">
                    <img
                        src="~/assets/gif/metro-news-after.gif"
                ...
                <p class="text-center mb-20">
                    Aefore | 手機版 - 標籤適應寬度變化，維持在同一行 | 電腦版
                    -重新安排區塊，讓最新消息有完整空間
                </p>
            ...
            <section>
                <h1 class="text-center mb-20">
                    設計畫面 03 - <br class="md:hidden" />需要照片的「相關景點」
                </h1>
                <h3 class="mb-4">01｜為景點放上圖片</h3>
                <p class="mb-20">
                ...
                <div class="flex flex-row justify-around mb-6">
                    <img
                        src="~/assets/gif/metro-landmark-before.gif"
                        alt="metro-news-before"
                        class="w-3/12 md:w-1/6"
                    />
                    <img
            ...
            <section>
                ...
                <p class="mb-20">
                    在整理台北捷運官網的時候，發現除了「網頁版」的畫面，在頂部導覽列也出現了「行動版」的連結，點選後出現的畫面，卻與實際使用手機開啟官網的畫面不同。「網頁版」與「行動版」的頁面風格迥異，字體也完全不同。可以推估，可能在原本的網頁製作成符合響應式設計之前，曾為了行動裝置而設計另一套頁面。因此決定仍然以現有的「網頁版」作為範本，重新規劃版面與設計。<br /><br />其中「最新運行狀況」的欄位，則是讓我猶豫比較久的，因為縮小畫面之後，為了能讓所有路線仍然在同一排，勢必需要將路線中文拿掉，但是對於不熟悉捷運系統的旅客來說，只靠顏色與英文代碼，就已經足夠分辨路線嗎？以及咖啡色的「文湖線」、橙色的「中和新蘆線」、鮮黃的「環狀線」屬於相同色系，缺少中文的狀況下，是否會有旅客情急之下看錯呢？如果維持中英文一併呈現，那就只能垂直排列，會佔去較多版面。。<br /><br />最後取捨下，只能讓中文盡量出現，最後手機尺寸的頁面，仍然只有英文代碼，而無中文。現在的呈現僅為我目前能做的較好的安排，但我希望能夠找到更好的呈現方式，再進行修改。
                </p>
            </section>
            <Hr :direction="'left'" class="mb-20" />
